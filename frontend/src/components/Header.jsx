      ...
      <nav className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {/* Certification */}
            <div className="relative group">
              <Link to="/certifications" className="flex items-center text-blue-700 hover:text-blue-500 font-medium">
                Certification
                <ChevronDown className="ml-1 w-4 h-4" />
              </Link>
          ...
          <div className="md:hidden bg-white shadow-lg mt-2 rounded-lg p-4 space-y-4">
            ...
            <div>
              ...
              <div className="ml-4 space-y-1">
                <Link to="/frameworks" className="block text-blue-600 hover:text-blue-500">Frameworks</Link>
                <Link to="/toolkits" className="block text-blue-600 hover:text-blue-500">Toolkits</Link>
                <Link to="/standards" className="block text-blue-600 hover:text-blue-500">Standards & Regulations</Link>
                <Link to="/blogs" className="block text-blue-600 hover:text-blue-500">Blogs</Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="ml-4 space-y-1">
                <Link to="/services/training" className="block text-blue-600 hover:text-blue-500">Training Service</Link>
                <Link to="/services/consulting" className="block text-blue-600 hover:text-blue-500">Consulting Service</Link>
              </div>
            </div>

            <div>
              <Link to="/certifications" className="text-blue-700 font-semibold hover:text-blue-500">Certification</Link>
              <div className="ml-4 space-y-1">
                <Link to="/certified-members" className="block text-blue-600 hover:text-blue-500">Certified Members</Link>
                <Link to="/accredited-trainers" className="block text-blue-600 hover:text-blue-500">Accredited Trainers</Link>
              </div>
            </div>
